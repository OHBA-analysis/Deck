...
%   popt  Struct or cell of options for dk.ui.plot_std
%   fopt  Struct or cell of options for dk.ui.plot_std
%
% OUTPUTS
%
...
%   -
%
% See also: fitrgp, dk.ui.plot_std
%
% JH
    ...
    if nargin > 4 || nargout > 2
        [ph,fh] = dk.ui.plot_std( reg.x, reg.y, reg.ci, popt, fopt );
    end
